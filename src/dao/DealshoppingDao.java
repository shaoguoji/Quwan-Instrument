...
public class DealShoppingDao {
	...
	public static void main(String[] args) {
		...
		comment.setComment_content("666");
	...
	// 通过用户名查询订单
	public ArrayList<ArrayList<DealShopping>> getDealsByUsername(String userName) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
	...
	// 通过用户名和订单号查询订单
	public ArrayList<DealShopping> getDealsByUsernameAndShopnum(
